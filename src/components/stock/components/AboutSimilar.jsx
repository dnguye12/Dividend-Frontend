...
const AboutSimilar = ({ ticker }) => {
            ...
            <tr className="hover cursor-pointer transition duration-300">
                <td>
                    <div className="flex items-center ">
                        <div className="rounded-full w-10 h-10 relative bg-base-950 border border-border flex items-center justify-center mr-2">
                ...
                <td className="font-bold text-sm text-text"><div className="h-4 w-10 skeleton my-1"></div></td>
    ...
    return (
        <tr className="hover cursor-pointer transition duration-300" onClick={() => {
            ...
            <td>
                <div className="flex items-center">
                    <div className="rounded-full w-10 h-10 bg-avatar border border-border flex items-center justify-center mr-2 drop-shadow">
                        {logoImg &&
            ...
            <td className="font-bold text-sm text-text">{currToSymbol(stockQuote.currency)}{myToLocaleString(stockQuote.regularMarketPrice)}</td>
            {
